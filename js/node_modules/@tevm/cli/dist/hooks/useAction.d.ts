 ...
 */
export declare const envVar: (name: string, prefix?: string) => string | undefined;
/**
 ...
 */
export declare function useAction<TParams, TResult>({ actionName, options, defaultValues, optionDescriptions, executeAction, createParams, }: UseActionOptions<TParams, TResult>): {
    result: any;
    formattedResult: string | undefined;
