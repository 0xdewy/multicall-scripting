...
export const InteractivePrompt = ({ defaultName, store }) => {
    ...
    const steps = [];
    steps.push(React.createElement(TextInputStep, { key: "name", name: "Name", isActive: store.currentStep === steps.length, color: "#A4DDED", step: {
            type: 'input',
    ...
    steps.push(React.createElement(MultipleChoiceStep, { key: "template", name: "Template", isActive: store.currentStep === steps.length, hide: store.currentStep < steps.length, color: "#B19CD9", multipleChoice: {
    ...
    return React.createElement(Box, { flexDirection: "column" }, ...steps);
};
