...
export const options = z.object({
    ...
    value: z.bigint().optional().describe(option({
        description: optionDescriptions.value,
    })),
    gas: z.bigint().optional().describe(option({
        description: optionDescriptions.gas,
    })),
    gasPrice: z.bigint().optional().describe(option({
        description: optionDescriptions.gasPrice,
    })),
    maxFeePerGas: z.bigint().optional().describe(option({
        description: optionDescriptions.maxFeePerGas,
    })),
    maxPriorityFeePerGas: z.bigint().optional().describe(option({
...
export default function EstimateGas({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `transaction to ${actionResult.options['to'] || '0x0000...0000'}`, successMessage: "Gas estimation completed successfully!" }));
}
