...
export const options = z.object({
    ...
    stateFile: z.string().optional().describe(option({
        description: optionDescriptions.stateFile,
    })),
    stateJson: z.string().optional().describe(option({
...
export default function LoadState({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: "load state", successMessage: "State loaded successfully!" }));
}
