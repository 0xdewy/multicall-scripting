...
export const options = z.object({
    ...
    nonce: z.number().optional().describe(option({
...
export default function SetNonce({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `account ${actionResult.options['address'] || '0x0000...0000'}`, successMessage: "Account nonce set successfully!" }));
}
