...
export const options = z.object({
    ...
    blockHash: z.string().optional().describe(option({
    ...
    includeTransactions: z.boolean().optional().describe(option({
...
export default function GetBlock({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: targetDesc, successMessage: "Block information retrieved successfully!" }));
}
