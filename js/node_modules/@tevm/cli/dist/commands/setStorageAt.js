...
export const options = z.object({
    ...
    index: z.string().optional().describe(option({
...
export default function SetStorageAt({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `storage slot ${actionResult.options['index'] || '0x0'} at ${actionResult.options['address'] || '0x0000...0000'}`, successMessage: "Storage value set successfully!" }));
}
