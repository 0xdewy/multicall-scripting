...
export const options = z.object({
    ...
    slot: z.string().optional().describe(option({
...
export default function GetStorageAt({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `storage slot ${actionResult.options['slot'] || '0x0'} at ${actionResult.options['address'] || '0x0000...0000'}`, successMessage: "Storage value retrieved successfully!" }));
}
