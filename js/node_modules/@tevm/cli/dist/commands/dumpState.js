...
export const options = z.object({
    ...
    // Output options
    outputFile: z.string().optional().describe(option({
...
export default function DumpState({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: "dump state", successMessage: "State dumped successfully!" }));
}
