...
export const options = z.object({
    ...
    returnStorage: z.boolean().default(false).describe(option({
...
export default function GetAccount({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `account ${actionResult.options['address']}`, successMessage: "Account retrieved successfully!" }));
}
