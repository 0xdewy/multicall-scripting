...
export default function GetChainId({ options }) {
    // Use the action hook
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: "chain", successMessage: "Chain ID retrieved successfully!" }));
}
