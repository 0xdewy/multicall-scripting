...
export const options = z.object({
    ...
    // Mining options
    blockCount: z.number().optional().describe(option({
        description: optionDescriptions.blockCount,
    })),
    interval: z.number().optional().describe(option({
...
export default function Mine({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `mine ${actionResult.options['blockCount'] || 1} block(s)`, successMessage: "Mining completed successfully!" }));
}
