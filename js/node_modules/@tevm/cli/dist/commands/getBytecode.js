...
export default function GetBytecode({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `contract at ${actionResult.options['address'] || '0x0000...0000'}`, successMessage: "Contract bytecode retrieved successfully!" }));
}
