...
export default function GetEnsAddress({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `ENS name ${actionResult.options['name'] || 'vitalik.eth'}`, successMessage: "ENS address resolved successfully!" }));
}
