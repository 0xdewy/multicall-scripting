...
export default function CreateEventFilter({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `${actionResult.options['eventName'] || 'all'} events on ${actionResult.options['address'] || '0x0000...0000'}`, successMessage: "Event filter created successfully!" }));
}
