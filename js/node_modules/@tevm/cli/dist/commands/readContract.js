...
export const options = z.object({
    ...
    // Transport options
    rpc: z.string().default('http://localhost:8545').describe(option({
    ...
    // Output formatting
    formatJson: z.boolean().default(true).describe(option({
...
export default function ReadContract({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `${actionResult.options.functionName} at ${actionResult.options.address}`, successMessage: "Contract read successfully!" }));
}
