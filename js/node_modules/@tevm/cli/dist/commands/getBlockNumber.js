...
export const options = z.object({
    ...
    cacheTime: z.number().optional().describe(option({
...
export default function GetBlockNumber({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: "current block number", successMessage: "Block number retrieved successfully!" }));
}
