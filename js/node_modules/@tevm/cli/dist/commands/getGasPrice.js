...
export default function GetGasPrice({ options }) {
    // Use the action hook
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: "current gas price", successMessage: "Gas price retrieved successfully!" }));
}
