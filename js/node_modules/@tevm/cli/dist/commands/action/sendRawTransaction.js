...
export const options = z.object({
    ...
    serializedTransaction: z.string().optional().describe(option({
...
export default function SendRawTransaction({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: "serialized transaction", successMessage: "Transaction sent successfully!" }));
}
