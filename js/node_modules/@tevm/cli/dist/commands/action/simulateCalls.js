...
export const options = z.object({
    ...
    traceAssetChanges: z.boolean().optional().describe(option({
        description: optionDescriptions.traceAssetChanges,
    })),
    traceTransfers: z.boolean().optional().describe(option({
        description: optionDescriptions.traceTransfers,
    })),
    validation: z.boolean().optional().describe(option({
...
export default function SimulateCalls({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `${(actionResult.options['calls'] || []).length} calls`, successMessage: "Calls simulated successfully!" }));
}
