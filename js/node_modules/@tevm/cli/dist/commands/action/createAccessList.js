...
export const options = z.object({
    ...
    blockNumber: z.string().optional().describe(option({
    ...
    // Transport options
    rpc: z.string().optional().describe(option({
        description: optionDescriptions.rpc,
        defaultValueDescription: 'http://localhost:8545',
    })),
    // Output formatting
    formatJson: z.boolean().optional().describe(option({
...
export default function CreateAccessList({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `transaction to ${actionResult.options['to'] || '0x7099...c8'}`, successMessage: "Access list created successfully!" }));
}
