...
export const options = z.object({
    ...
    // Account properties
    nonce: z.string().optional().describe(option({
        description: optionDescriptions.nonce,
    })),
    balance: z.string().optional().describe(option({
    ...
    storageRoot: z.string().optional().describe(option({
        description: optionDescriptions.storageRoot,
    })),
    state: z.record(z.string(), z.string()).optional().describe(option({
        description: optionDescriptions.state,
    })),
    stateDiff: z.record(z.string(), z.string()).optional().describe(option({
...
export default function SetAccount({ options }) {
    ...
    const actionResult = useAction({
        ...
        createParams: (enhancedOptions) => {
            const targetAddress = enhancedOptions['address'];
            if (!targetAddress) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `account ${actionResult.options['address']}`, successMessage: "Account properties set successfully!" }));
}
