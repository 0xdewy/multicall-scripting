...
export const options = z.object({
    ...
    createTransaction: z.enum(['on-success', 'always', 'never']).default('always').describe(option({
...
export default function Deploy({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: "contract deployment", successMessage: "Contract deployed successfully!" }));
}
