...
export const options = z.object({
    ...
    name: z.string().optional().describe(option({
        description: optionDescriptions.name,
    })),
    key: z.string().optional().describe(option({
    ...
    universalResolverAddress: z.string().optional().describe(option({
...
export default function GetEnsText({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `${actionResult.options['key'] || 'url'} record for ${actionResult.options['name'] || 'vitalik.eth'}`, successMessage: "ENS text record retrieved successfully!" }));
}
