...
export const options = z.object({
    ...
    bytecode: z.string().optional().describe(option({
...
export default function SetCode({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `contract at ${actionResult.options['address'] || '0x0000...0000'}`, successMessage: "Contract bytecode set successfully!" }));
}
