...
export const options = z.object({
    ...
    contracts: z.string().optional().describe(option({
        description: optionDescriptions.contracts,
    })),
    multicallAddress: z.string().optional().describe(option({
        description: optionDescriptions.multicallAddress,
    })),
    allowFailure: z.boolean().optional().describe(option({
...
export default function Multicall({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `${parseContracts(actionResult.options['contracts']).length} contract calls`, successMessage: "Multicall executed successfully!" }));
}
