...
export const options = z.object({
    ...
    type: z.string().optional().describe(option({
...
export default function EstimateFeesPerGas({ options }) {
    ...
    return (React.createElement(CliAction, { ...actionResult, targetName: `fees for ${actionResult.options['type'] || 'eip1559'} transactions`, successMessage: "Fee estimation completed successfully!" }));
}
