...
export const options = z.object({
    skipPrompts: z.boolean().default(envVar('skip_prompts') === 'true' || false).describe(option({
        description: 'Bypass interactive CLI prompt and use only command line flag options (env: TEVM_SKIP_PROMPTS)',
    })),
    template: z.enum(['hardhat', 'foundry']).default(envVar('template') || 'hardhat').describe(option({
