...
import { numberToHex, bytesToHex as bytesToHex$1, isHex, hexToBytes as hexToBytes$1, hexToNumber } from '@tevm/utils';
...
var getBlock = (baseChain) => async (blockId) => {
  const block = (() => {
    ...
    if (blockId instanceof Uint8Array) {
      baseChain.logger.debug({ blockId: bytesToHex$1(blockId) }, "getting block by hash");
      return baseChain.blocks.get(bytesToHex$1(blockId));
    }
