...
var defaultSolc2__default = /*#__PURE__*/_interopDefault(defaultSolc2);
...
// src/tevmUnplugin.js
var defaultVersion = defaultSolc2__default.default.version().slice(0, defaultSolc2__default.default.version().indexOf("+"));
...
var tevmUnplugin = (options = {}) => {
  ...
  return {
    ...
    async buildStart() {
      ...
      const versionedSolc = parsedSolcVersion.data === defaultVersion ? defaultSolc2__default.default : await solc.createSolc(parsedSolcVersion.data);
