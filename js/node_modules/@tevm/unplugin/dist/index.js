...
// src/tevmUnplugin.js
var defaultVersion = defaultSolc2.version().slice(0, defaultSolc2.version().indexOf("+"));
...
var tevmUnplugin = (options = {}) => {
  ...
  return {
    ...
    async buildStart() {
      ...
      const versionedSolc = parsedSolcVersion.data === defaultVersion ? defaultSolc2 : await createSolc(parsedSolcVersion.data);
