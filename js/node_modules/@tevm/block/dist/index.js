...
import { numberToHex, toBytes, equalsBytes, keccak256, KECCAK256_RLP_ARRAY, EthjsAddress, KECCAK256_RLP, concatBytes, bytesToHex, bytesToBigInt, ecrecover, hexToBytes, bytesToUtf8, createWithdrawal, toType, TypeOutput, setLengthLeft, isHex } from '@tevm/utils';
...
var BlockHeader = class _BlockHeader {
  ...
  cliqueExtraSeal() {
    ...
    return this.extraData.subarray(-65);
  }
  /**
