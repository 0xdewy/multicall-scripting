 ...
 */
export declare function createBlockFromValuesArray(values: BlockBytes, opts: BlockOptions): Block;
/**
 ...
 */
export declare function createBlockFromBeaconPayload(payload: BeaconPayloadJson, opts: BlockOptions): Promise<Block>;
/**
 ...
 */
export declare function createBlockHeaderFromValuesArray(values: BlockHeaderBytes, opts: BlockOptions): BlockHeader;
