...
var ResourceNotFoundError = class extends BaseError {
  /**
...
var GasLimitExceededError = class extends BaseError {
  /**
...
var InvalidGasPriceError = class extends BaseError {
  /**
...
var InvalidRequestError = class extends BaseError {
  /**
...
var InvalidTransactionError = class extends BaseError {
  /**
...
var NonceAlreadyUsedError = class extends BaseError {
  /**
...
var RateLimitExceededError = class extends BaseError {
  /**
...
var UnsupportedChainError = class extends BaseError {
  /**
...
var BLS12381FpNotInFieldError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.BLS_12_381_FP_NOT_IN_FIELD;
  /**
...
var BLS12381InputEmptyError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.BLS_12_381_INPUT_EMPTY;
  /**
...
var BLS12381InvalidInputLengthError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.BLS_12_381_INVALID_INPUT_LENGTH;
  /**
...
var BLS12381PointNotOnCurveError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.BLS_12_381_POINT_NOT_ON_CURVE;
  /**
...
var CodeStoreOutOfGasError = class extends GasLimitExceededError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.CODESTORE_OUT_OF_GAS;
  /**
...
var CodeSizeExceedsMaximumError = class extends GasLimitExceededError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.CODESIZE_EXCEEDS_MAXIMUM;
  /**
...
var CreateCollisionError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.CREATE_COLLISION;
  /**
...
var InvalidCommitmentError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.INVALID_COMMITMENT;
  /**
...
var EvmRevertError = class extends RevertError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.REVERT;
  /**
...
var InitcodeSizeViolationError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.INITCODE_SIZE_VIOLATION;
  /**
...
var InsufficientBalanceError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.INSUFFICIENT_BALANCE;
  /**
...
var InternalEvmError = class extends BaseError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.INTERNAL_ERROR;
  /**
...
var InvalidBytecodeResultError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.INVALID_BYTECODE_RESULT;
  /**
...
var InvalidEofFormatError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.INVALID_EOF_FORMAT;
  /**
...
var InvalidInputLengthError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.INVALID_INPUT_LENGTH;
  /**
...
var InvalidJumpError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.INVALID_JUMP;
  /**
...
var InvalidKzgInputsError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.INVALID_INPUTS;
  /**
...
var InvalidOpcodeError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.INVALID_OPCODE;
  /**
...
var InvalidProofError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.INVALID_PROOF;
  /**
...
var OutOfGasError = class extends GasLimitExceededError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.OUT_OF_GAS;
  /**
...
var OutOfRangeError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.OUT_OF_RANGE;
  /**
...
var RefundExhaustedError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.REFUND_EXHAUSTED;
  /**
...
var StackOverflowError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.STACK_OVERFLOW;
  /**
...
var StackUnderflowError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.STACK_UNDERFLOW;
  /**
...
var StaticStateChangeError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.STATIC_STATE_CHANGE;
  /**
...
var StopError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.STOP;
  /**
...
var ValueOverflowError = class extends ExecutionError {
  /** @type {string} */
  static EVMErrorMessage = evm.EVMError.errorMessages.VALUE_OVERFLOW;
  /**
