...
import { TevmState, ParameterizedTevmState, StateRoots } from '@tevm/state';
...
declare const zBaseCallParams: z.ZodEffects<z.ZodObject<{
 ...
 */
declare const zCallParams: z.ZodEffects<z.ZodEffects<z.ZodIntersection<z.ZodEffects<z.ZodObject<{
    throwOnFail: z.ZodOptional<z.ZodBoolean>;
} & {
    createTrace: z.ZodOptional<z.ZodBoolean>;
    createAccessList: z.ZodOptional<z.ZodBoolean>;
 ...
 */
declare const zContractParams: z.ZodEffects<z.ZodEffects<z.ZodIntersection<z.ZodEffects<z.ZodObject<{
    throwOnFail: z.ZodOptional<z.ZodBoolean>;
} & {
    createTrace: z.ZodOptional<z.ZodBoolean>;
    createAccessList: z.ZodOptional<z.ZodBoolean>;
    ...
    abi: z.ZodReadonly<z.ZodArray<z.ZodUnion<[z.ZodObject<{
        ...
        inputs: z.ZodReadonly<z.ZodArray<z.ZodType<abitype.AbiParameter, z.ZodTypeDef, abitype.AbiParameter>, "many">>;
        name: z.ZodString;
    }, "strip", z.ZodTypeAny, {
        ...
        inputs: z.ZodReadonly<z.ZodArray<z.ZodType<abitype.AbiEventParameter, z.ZodTypeDef, abitype.AbiEventParameter>, "many">>;
        name: z.ZodString;
    }, "strip", z.ZodTypeAny, {
        inputs: readonly abitype.AbiEventParameter[];
        type: "event";
        name: string;
        ...
        inputs: z.ZodReadonly<z.ZodArray<z.ZodType<abitype.AbiParameter, z.ZodTypeDef, abitype.AbiParameter>, "many">>;
        name: z.ZodString;
        outputs: z.ZodReadonly<z.ZodArray<z.ZodType<abitype.AbiParameter, z.ZodTypeDef, abitype.AbiParameter>, "many">>;
        stateMutability: z.ZodUnion<[z.ZodLiteral<"pure">, z.ZodLiteral<"view">, z.ZodLiteral<"nonpayable">, z.ZodLiteral<"payable">]>;
    }, "strip", z.ZodTypeAny, {
        inputs: readonly abitype.AbiParameter[];
        outputs: readonly abitype.AbiParameter[];
        type: "function";
        name: string;
...
type TevmSetAccountError = ValidateSetAccountParamsError | InternalError;
 ...
 */
declare const zSetAccountParams: z.ZodEffects<z.ZodObject<{
    throwOnFail: z.ZodOptional<z.ZodBoolean>;
} & {
    address: z.ZodEffects<z.ZodString, `0x${string}`, string>;
    balance: z.ZodOptional<z.ZodBigInt>;
 ...
 */
type TraceParams<TTracer extends 'callTracer' | 'prestateTracer' | undefined = 'callTracer' | 'prestateTracer' | undefined, TDiffMode extends boolean = boolean> = {
    /**
     * The type of tracer
 ...
 */
type DebugTraceTransactionParams<TTracer extends 'callTracer' | 'prestateTracer' | undefined = 'callTracer' | 'prestateTracer' | undefined, TDiffMode extends boolean = boolean, TTTThrowOnError extends boolean = boolean> = BaseParams<TTTThrowOnError> & TraceParams<TTracer, TDiffMode> & {
    /**
     * The transaction hash
     */
    readonly transactionHash: Hex;
 ...
 */
type DebugTraceCallParams<TTracer extends 'callTracer' | 'prestateTracer' | undefined = 'callTracer' | 'prestateTracer' | undefined, TDiffMode extends boolean = boolean> = TraceParams<TTracer, TDiffMode> & EthCallParams;
/**
 * Params taken by `debug_traceBlock` handler
 */
type DebugTraceBlockParams<TTracer extends 'callTracer' | 'prestateTracer' | undefined = 'callTracer' | 'prestateTracer' | undefined, TDiffMode extends boolean = boolean> = TraceParams<TTracer, TDiffMode> & ExactlyOne<{
    /**
 ...
 */
type DebugTraceTransactionResult<TTracer extends 'callTracer' | 'prestateTracer' | undefined = 'callTracer' | 'prestateTracer' | undefined, TDiffMode extends boolean = boolean> = TTracer extends 'callTracer' ? CallTraceResult : TTracer extends 'prestateTracer' ? PrestateTraceResult<TDiffMode> : TraceResult;
/**
 * Result from `debug_traceCall`
 */
type DebugTraceCallResult<TTracer extends 'callTracer' | 'prestateTracer' | undefined = 'callTracer' | 'prestateTracer' | undefined, TDiffMode extends boolean = boolean> = TTracer extends 'callTracer' ? CallTraceResult : TTracer extends 'prestateTracer' ? PrestateTraceResult<TDiffMode> : TraceResult;
/**
 * Result from `debug_traceBlock`.
 *
 * Returns an array of transaction traces
 */
type DebugTraceBlockResult<TTracer extends 'callTracer' | 'prestateTracer' | undefined = 'callTracer' | 'prestateTracer' | undefined, TDiffMode extends boolean = boolean> = Array<{
    /**
     * Transaction hash
     */
    txHash: Hex;
...
type DebugTraceCallHandler = <TTracer extends 'callTracer' | 'prestateTracer' = 'callTracer' | 'prestateTracer', TDiffMode extends boolean = boolean>(params: DebugTraceCallParams<TTracer, TDiffMode>) => Promise<DebugTraceCallResult<TTracer, TDiffMode>>;
 ...
 */
declare class BlobGasLimitExceededError extends Error {
    constructor();
    /**
     ...
     * @override
     */
    override name: "BlobGasLimitExceededError";
}
...
declare class NoForkUrlSetError extends Error {
    /**
     ...
     * @override
     */
    override name: "NoForkUrlSetError";
}
 ...
 */
declare const zAbi: zod.ZodReadonly<zod.ZodArray<zod.ZodUnion<[zod.ZodObject<{
    type: zod.ZodLiteral<"error">;
    inputs: zod.ZodReadonly<zod.ZodArray<zod.ZodType<abitype.AbiParameter, zod.ZodTypeDef, abitype.AbiParameter>, "many">>;
    name: zod.ZodString;
    ...
    type: zod.ZodLiteral<"event">;
    anonymous: zod.ZodOptional<zod.ZodBoolean>;
    inputs: zod.ZodReadonly<zod.ZodArray<zod.ZodType<abitype.AbiEventParameter, zod.ZodTypeDef, abitype.AbiEventParameter>, "many">>;
    name: zod.ZodString;
}, "strip", zod.ZodTypeAny, {
    inputs: readonly abitype.AbiEventParameter[];
    type: "event";
    ...
    name: string;
    anonymous?: boolean | undefined;
}>, zod.ZodEffects<zod.ZodIntersection<zod.ZodObject<{
    constant: zod.ZodOptional<zod.ZodBoolean>;
    gas: zod.ZodOptional<zod.ZodNumber>;
    payable: zod.ZodOptional<zod.ZodBoolean>;
}, "strip", zod.ZodTypeAny, {
    payable?: boolean | undefined;
    constant?: boolean | undefined;
    gas?: number | undefined;
    ...
    inputs: zod.ZodReadonly<zod.ZodArray<zod.ZodType<abitype.AbiParameter, zod.ZodTypeDef, abitype.AbiParameter>, "many">>;
    name: zod.ZodString;
    outputs: zod.ZodReadonly<zod.ZodArray<zod.ZodType<abitype.AbiParameter, zod.ZodTypeDef, abitype.AbiParameter>, "many">>;
    stateMutability: zod.ZodUnion<[zod.ZodLiteral<"pure">, zod.ZodLiteral<"view">, zod.ZodLiteral<"nonpayable">, zod.ZodLiteral<"payable">]>;
}, "strip", zod.ZodTypeAny, {
    inputs: readonly abitype.AbiParameter[];
    outputs: readonly abitype.AbiParameter[];
    type: "function";
    ...
    type: zod.ZodLiteral<"constructor">;
    inputs: zod.ZodReadonly<zod.ZodArray<zod.ZodType<abitype.AbiParameter, zod.ZodTypeDef, abitype.AbiParameter>, "many">>;
    stateMutability: zod.ZodUnion<[zod.ZodLiteral<"payable">, zod.ZodLiteral<"nonpayable">]>;
}, "strip", zod.ZodTypeAny, {
    inputs: readonly abitype.AbiParameter[];
    type: "constructor";
    stateMutability: "nonpayable" | "payable";
    ...
    type: zod.ZodLiteral<"fallback">;
    inputs: zod.ZodOptional<zod.ZodTuple<[], null>>;
    stateMutability: zod.ZodUnion<[zod.ZodLiteral<"payable">, zod.ZodLiteral<"nonpayable">]>;
}, "strip", zod.ZodTypeAny, {
    type: "fallback";
    stateMutability: "nonpayable" | "payable";
    ...
    type: zod.ZodLiteral<"receive">;
    stateMutability: zod.ZodLiteral<"payable">;
}, "strip", zod.ZodTypeAny, {
    type: "receive";
    stateMutability: "payable";
}, {
 ...
 */
declare const zAddress: zod.ZodEffects<zod.ZodString, `0x${string}`, string>;
 ...
 */
declare const zBytecode: zod.ZodEffects<zod.ZodEffects<zod.ZodString, `0x${string}`, string>, `0x${string}`, string>;

/**
 * Zod validator for a valid hex string
 */
declare const zHex: z.ZodEffects<z.ZodString, `0x${string}`, string>;

/**
 * Zod validator for valid ethereum storage root
 */
declare const zStorageRoot: z.ZodEffects<z.ZodString, string, string>;
...
declare const zBlockParam: z.ZodUnion<[z.ZodLiteral<"latest">, z.ZodLiteral<"earliest">, z.ZodLiteral<"pending">, z.ZodLiteral<"safe">, z.ZodLiteral<"finalized">, z.ZodBigInt, z.ZodEffects<z.ZodNumber, bigint, number>, z.ZodEffects<z.ZodString, `0x${string}`, string>]>;

declare const zStateOverrideSet: z.ZodRecord<z.ZodEffects<z.ZodString, `0x${string}`, string>, z.ZodObject<{
    balance: z.ZodOptional<z.ZodBigInt>;
    nonce: z.ZodOptional<z.ZodBigInt>;
    code: z.ZodOptional<z.ZodEffects<z.ZodString, `0x${string}`, string>>;
    state: z.ZodOptional<z.ZodRecord<z.ZodEffects<z.ZodString, `0x${string}`, string>, z.ZodEffects<z.ZodString, `0x${string}`, string>>>;
 ...
 */
type DebugTraceTransactionJsonRpcRequest<TTracer extends 'callTracer' | 'prestateTracer' | undefined = 'callTracer' | 'prestateTracer' | undefined, TDiffMode extends boolean = boolean, TTTThrowOnError extends boolean = boolean> = JsonRpcRequest<'debug_traceTransaction', [
    SerializeToJson<DebugTraceTransactionParams<TTracer, TDiffMode, TTTThrowOnError>>
]>;
/**
 * JSON-RPC request for `debug_traceCall` method
 */
type DebugTraceCallJsonRpcRequest<TTracer extends 'callTracer' | 'prestateTracer' | undefined = 'callTracer' | 'prestateTracer' | undefined, TDiffMode extends boolean = boolean> = JsonRpcRequest<'debug_traceCall', [SerializeToJson<DebugTraceCallParams<TTracer, TDiffMode>>]>;
/**
 * JSON-RPC request for `debug_traceBlock`
 */
type DebugTraceBlockJsonRpcRequest<TTracer extends 'callTracer' | 'prestateTracer' | undefined = 'callTracer' | 'prestateTracer' | undefined, TDiffMode extends boolean = boolean> = JsonRpcRequest<'debug_traceBlock', [SerializeToJson<DebugTraceBlockParams<TTracer, TDiffMode>>]>;
/**
 ...
 */
type DebugTraceTransactionJsonRpcResponse<TTracer extends 'callTracer' | 'prestateTracer' = 'callTracer' | 'prestateTracer', TDiffMode extends boolean = boolean> = JsonRpcResponse<'debug_traceTransaction', SerializeToJson<DebugTraceTransactionResult<TTracer, TDiffMode>>, DebugError>;
/**
 * JSON-RPC response for `debug_traceCall` procedure
 */
type DebugTraceCallJsonRpcResponse<TTracer extends 'callTracer' | 'prestateTracer' = 'callTracer' | 'prestateTracer', TDiffMode extends boolean = boolean> = JsonRpcResponse<'debug_traceCall', SerializeToJson<DebugTraceCallResult<TTracer, TDiffMode>>, DebugError>;
/**
 * JSON-RPC response for `debug_traceBlock`
 */
type DebugTraceBlockJsonRpcResponse<TTracer extends 'callTracer' | 'prestateTracer' = 'callTracer' | 'prestateTracer', TDiffMode extends boolean = boolean> = JsonRpcResponse<'debug_traceBlock', SerializeToJson<DebugTraceBlockResult<TTracer, TDiffMode>>, DebugError>;
/**
