...
var testAccounts = (
   ...
   */
  oneToTen.map((i) => accounts.mnemonicToAccount(mnemonic, { addressIndex: i }))
);
...
var formatBlockTag = (blockTag) => {
  ...
  if (typeof blockTag === "bigint") {
    return viem.numberToHex(blockTag);
  }
  return blockTag;
};
  ...
  return (client) => {
          ...
          params: [
            {
              ...
              ...params.balance ? { balance: viem.numberToHex(params.balance) } : {},
              ...params.nonce ? { nonce: viem.numberToHex(params.nonce) } : {},
    ...
    const getCallArgs = (params) => {
      return {
        ...
        ...params.gas ? { gas: viem.numberToHex(params.gas) } : {},
        ...params.gasPrice ? { gasPrice: viem.numberToHex(params.gasPrice) } : {},
        ...params.gasRefund ? { gasRefund: viem.numberToHex(params.gasRefund) } : {},
        ...
        ...params.value ? { value: viem.numberToHex(params.value) } : {}
      };
    };
    ...
    const parseCallResponse = (response) => {
      ...
      return {
        executionGasUsed: viem.hexToBigInt(result.executionGasUsed),
        rawData: result.rawData,
        ...result.selfdestruct ? { selfdestruct: new Set(result.selfdestruct) } : {},
        ...result.gasRefund ? { gasRefund: viem.hexToBigInt(result.gasRefund) } : {},
        ...result.gas ? { gas: viem.hexToBigInt(result.gas) } : {},
        ...result.logs ? { logs: result.logs } : {},
        ...result.blobGasUsed ? { blobGasUsed: viem.hexToBigInt(result.blobGasUsed) } : {},
        ...
        formatResult(
          await request({
            ...
            params: [
              {
                from,
                ...gas ? { gas: viem.numberToHex(gas) } : {},
                ...gasPrice2 ? { gasPrice: viem.numberToHex(gasPrice2) } : {},
                ...to ? { to } : {},
                ...value ? { value: viem.numberToHex(value) } : {},
                ...data ? { data } : {}
              },
...
exports.tevmTransport = tevmTransport;
